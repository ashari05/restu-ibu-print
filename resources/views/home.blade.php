  ...
  <div class="max-w-6xl mx-auto px-4 py-14 text-center">
    <div class="max-w-xl mx-auto">
      <h1 class="text-3xl md:text-5xl font-extrabold leading-tight">
        Custom & Printing untuk Bisnis <span class="text-sky-600">Lebih Menonjol</span>
      </h1>
      ...
      <div class="mt-6 flex flex-wrap gap-3 justify-center">
        <a href="{{ url('/produk') }}"
            class="inline-flex items-center justify-center px-5 py-3 rounded-lg bg-sky-600 text-white font-semibold hover:bg-sky-700">
            Lihat Produk
        </a>
      ...
      <a href="{{ url('/kontak') }}"
         class="mt-4 inline-flex md:w-auto items-center justify-center px-5 py-3 rounded-lg bg-sky-600 text-white font-semibold hover:bg-sky-700">
        Hubungi Kami
      </a>
    </div>
  </div>
...
<section id="why" class="py-16 bg-white">
  <div class="max-w-6xl mx-auto px-4">
    ...
    <div class="mt-8 text-center">
      <a href="kontak.php" class="inline-flex items-center px-5 py-3 rounded-lg border font-semibold hover:bg-gray-100">
        Hubungi Kami
      </a>
    </div>
  </div>
